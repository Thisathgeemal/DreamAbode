    ...
    <section class="relative h-[550px] flex flex-col md:flex-row items-center mt-6">
        ...
        <div
            ...
            <h2
                ...
                Discover a comfortable and convenient <br class="hidden md:block"> home from our curated selection of
                rental <br class="hidden md:block"> properties, ranging from cozy apartments <br class="hidden md:block">
                to spacious houses.
            </h2>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-center w-full h-full">
                <img src="./images/RentalsBg.png" alt="Rental Bg"
                    class="w-[90vw] h-[250px] md:w-[90%] md:h-[95%] object-contain">
            </div>

            <!-- Mobile: Only small floating button -->
            <a href="./postAd" class="absolute bottom-[-35px] right-4 md:hidden flex items-center justify-center z-50">
                <div
