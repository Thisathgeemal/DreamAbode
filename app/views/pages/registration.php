...
<body>
    ...
    <section class="bg-white flex items-center justify-center px-2 py-6 md:px-4 md:py-8">
        <div class="bg-white p-4 rounded-xl w-full max-w-xs shadow-[0_0_15px_4px_rgba(92,255,171,0.4)] md:p-8 md:max-w-md">
            <form method="POST" action="./memberProfile/signupMember">
                <h2 class="text-2xl md:text-4xl font-bold mb-5 md:mb-7 text-center poppins">Sign Up</h2>
                ...
                <div class="mb-2">
                    <label for="username" class="block text-base md:text-lg font-medium text-gray-700">Username</label>
                ...
                <div class="mb-2">
                    <label for="email" class="block text-base md:text-lg font-medium text-gray-700">Email</label>
                ...
                <div class="mb-2">
                    <label for="mobile" class="block text-base md:text-lg font-medium text-gray-700">Mobile Number</label>
                ...
                <div class="mb-2">
                    <label for="password" class="block text-base md:text-lg font-medium text-gray-700">Password</label>
                ...
                <div class="mb-2">
                    <label for="confirmPassword" class="block text-base md:text-lg font-medium text-gray-700">Confirm Password</label>
