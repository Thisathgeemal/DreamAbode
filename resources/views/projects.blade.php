    ...
    <section class="relative h-[550px] flex flex-col md:flex-row items-center mt-6">
        ...
        <div
            ...
            <h2
                ...
                Stay updated with our ongoing, upcoming, and <br class="hidden md:block"> completed projects, showcasing
                innovation, <br class="hidden md:block">
                quality, and excellence in every build.
            </h2>
        </div>
