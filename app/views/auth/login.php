        ...
        <form>
            ...
            <div class="flex items-center justify-between mt-3">
                <label class="flex items-center text-gray-700 text-sm mt2">
                    <input type="checkbox" class="form-checkbox h-4 w-4 text-green-500 focus:ring-green-500 rounded">
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <button class="bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Google
                </button>
                <button class="bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Facebook
            ...
            <button type="submit" class="w-full bg-green-400  hover:bg-green-200 text-black font-semibold mt-4 py-2 px-4 rounded-md border border-green-300 shadow-sm transition-colors duration-200">Login</button>

            <div class="text-center mt-2">
                <a href="#" class="inline-block font-semibold text-sm text-black align-middle">Need a new account? <span class="text-green-500 hover:text-green-700">Sign up</span></a>
            </div>
        </form>
    </div>
    </section>
