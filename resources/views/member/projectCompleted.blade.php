<x-app-layout>
    ...
    <div class="w-full px-8 py-6 bg-[#161616] rounded-lg text-left mx-auto shadow-md mb-6">
        ...
        <p class="text-sm text-gray-300 mt-1">Here you can view projects that have been successfully completed.</p>
    </div>
        ...
        <script>
            ...
            async function fetchCompletedProjects() {
                ...
                try {
                    ...
                    const projects = response.data.user_projects.completed;
                    container.innerHTML = '';
