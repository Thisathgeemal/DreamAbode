    ...
    <section class="p-10 w-full">
        <div class="text-center">
            ...
            <div class="flex flex-col md:flex-row gap-10 items-center justify-center">
                ...
                <div class="w-[280px] h-[400px] bg-[#5CFFAB] rounded-xl p-4 flex flex-col justify-center items-center text-center shadow-xl transition duration-300 ease-in-out hover:bg-[#42e697] hover:shadow-md cursor-pointer">
                    ...
                    <button class="w-[100px] h-[40px] text-sm rounded-md bg-white text-black md:mt-4 border border-green-400 transition duration-300 ease-in-out hover:scale-105 hover:bg-gray-200 cursor-pointer">
                        Get Started
                    </button>
                </div>
