<x-app-layout>
    ...
    <div class="w-full px-8 py-6 bg-[#161616] rounded-lg text-left mx-auto shadow-md mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl text-white font-bold">Accepted Projects</h2>
                <p class="text-sm text-gray-300 mt-1">Review all your accepted project listings.</p>
            </div>
        ...
        <script>
            ...
            async function fetchAcceptedProjects() {
                ...
                try {
                    ...
                    const projects = response.data.user_projects.approved;
                    container.innerHTML = '';
                    ...
                    `;
                        ...
                        // View Button for approved projects
