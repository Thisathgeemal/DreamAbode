...
class Agent
{
    ...
    {
        $query = "INSERT INTO " . $this->table . " (Username, Password, Email, MobileNumber, DOB, Gender, Image, created_at) 
                  VALUES (:username, :password, :email, :mobile, :dob, :gender, :image, NOW())";
    ...
    public function removeAgentById($userId)
    {
