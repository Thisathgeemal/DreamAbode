...
<body>
    ...
    <section class="bg-white flex items-center justify-center px-2 py-8">
        <div class="bg-white p-8 rounded-xl max-w-3xl w-full shadow-[0_0_15px_4px_rgba(92,255,171,0.4)]">
            <h2 class="text-4xl font-bold mb-6 mt-3 text-center">Add a Project</h2>

            <!-- Top Image Section -->
            <form action="./postProject/addProject" method="POST" enctype="multipart/form-data" class="max-w-2xl mx-auto p-6 bg-white">
                ...
                <div class="flex space-x-6">
                    ...
                    <div class="flex-1 space-y-4">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="measurement" name="measurement" placeholder="E.g. 2000"
                                class="mt-1 block w-full bg-green-100 border border-gray-300 rounded-md shadow-sm p-2 text-black placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-green-400">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center space-x-4 mt-6">
                    ...
                    <a href="./memberProfile?section=manage_project"><button type="button" class="bg-red-500 text-white font-semibold py-2 px-6 rounded-lg hover:bg-red-600 w-[100px]">Discard</button></a>
                </div>
            </form>
        </div>
    </section>
