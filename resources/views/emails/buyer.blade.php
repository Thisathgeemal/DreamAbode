    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="credentials">
                <p><span class="label">Property Name:</span> {{ $property->property_name }}</p>
                <p><span class="label">Property Type:</span> {{ $property->post_type }}</p>
            ...
            <!-- Seller Details -->
            <div class="credentials">
                <p><span class="label">Property Owner Name:</span> {{ $member->name }}</p>
                <p><span class="label">Property Owner Email:</span> {{ $member->email }}</p>
                <p><span class="label">Property Owner Mobile:</span> {{ $member->mobile_number }}</p>
                <p><span class="label">Property Owner Address:</span> {{ $member->address }}</p>
            </div>
