...
<body>
        ...
        <section class="p-10 w-full">
            <h1 class="flex justify-center align-miiddle text-4xl font-bold poppins p-4 my-6">Agent Details</h1>
            <!-- Top Button Groups -->
...
<?php endif; ?>
            ...
            <form id="deleteForm" method="POST" action="./agentProfile/deleteAgent">
                <section id="property-container-view" class="p-4 justify-center">
