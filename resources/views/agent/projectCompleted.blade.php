<x-agent-layout>
    ...
    <div class="w-full px-8 py-6 bg-[#161616] rounded-lg text-left mx-auto shadow-md mb-6">
        ...
        <p class="text-sm text-gray-300 mt-1">Review all your completed project deals.</p>
    </div>
    ...
    @push('scripts')
        <script>
            ...
            async function fetchCompletedProjects() {
                const container = document.getElementById('completed-project');
                container.innerHTML = `
                ...
                try {
                    ...
                    const projects = response.data.agent_projects.completed;
                    container.innerHTML = '';
