...
<body>
    ...
    <section class="bg-white flex items-center justify-center px-2 py-8">
        <div class="bg-white p-8 rounded-xl w-full max-w-xs md:max-w-md shadow-[0_0_15px_4px_rgba(92,255,171,0.4)]">
            <form method="POST" action="./login/login">
                <h2 class="text-4xl font-bold mb-7 text-center poppins">Login</h2>
            ...
            <?php endif; ?>
                ...
                <div class="flex items-center justify-between mt-3">
                    ...
                    <a href="./forgetPassword" class="inline-block align-baseline font-semibold text-sm text-green-500 hover:text-green-700">Forgot Password?</a>
                </div>
